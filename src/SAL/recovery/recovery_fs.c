...
static void fs_create_clid_name(nfs_client_id_t* clientid)
{
        ...
        PATH_MAX) > 0)
    {
        ...
        (void)snprintf(clientid->cid_recov_tag,
                       total_len,
                       "%s-(%s:%s)",
                       str_client_addr,
                       cidstr_len,
                                 ...
                                 add_rfh_entry_hook add_rfh_entry)
{
    ...
    rc = fs_read_recov_clids_impl(v4_old_dir,
                                  NULL,
                                  NULL,
                                  0,
                                  add_clid_entry,
    ...
    rc = fs_read_recov_clids_impl(v4_recov_dir,
                                  NULL,
                                  v4_old_dir,
                                  0,
                                  add_clid_entry,
                                  ...
                                  add_rfh_entry_hook add_rfh_entry)
{
    ...
    rc = fs_read_recov_clids_impl(path,
                                  NULL,
                                  v4_old_dir,
                                  1,
                                  add_clid_entry,
