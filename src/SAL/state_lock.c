                    ...
                    int32_t refcount, char* file, int line, char* function)
{
    if(isFullDebug(COMPONENT_STATE))
    {
        ...
        DisplayLogComponentLevel(COMPONENT_STATE,
                                 file,
                                 line,
                                 function,
                                 NIV_FULL_DEBUG,
                                              ...
                                              struct glist_head* list)
{
    ...
    *removed = false;
    ...
    glist_for_each_safe(glist, glistn, list)
    {
         ...
         */
        status =
                subtract_lock_from_entry(found_entry,
                                         lock,
                                         &split_lock_list,
                                         &remove_list,
                                         &removed_one);
                                              ...
                                              struct glist_head* source)
{
    ...
    glist_for_each_safe(glist, glistn, source)
    {
        ...
        status = subtract_lock_from_list(NULL,
                                         false,
                                         0,
                                  ...
                                  state_lock_entry_t* lock_entry)
{
    ...
    if(lock_entry->sle_block_data != NULL)
    {
        ...
        else
        {
             ...
             */
            memset(lock_entry->sle_block_data,
                   0,
...
static void grant_blocked_locks(struct state_hdl* ostate)
{
    ...
    glist_for_each_safe(glist, glistn, &ostate->file.lock_list)
    {
         ...
         */
        if(get_overlapping_entry(ostate,
                                  ...
                                  fsal_lock_param_t* lock)
{
    ...
    status = subtract_list_from_list(obj,
                                     &fsal_unlock_list,
                            ...
                            fsal_lock_param_t* lock)
{
     ...
     */
    cancel_blocked_locks_range(obj->state_hdl,
                               owner,
                               state_applies,
                               nsm_state,
                               lock);
    ...
    status = subtract_lock_from_list(owner,
                                     state_applies,
                                     nsm_state,
                                     lock,
                                     &removed,
