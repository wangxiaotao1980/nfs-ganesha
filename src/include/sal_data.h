...
typedef enum state_owner_type_t
{
    ...
    /*< An NFSv4 owner of an open */
    STATE_LOCK_OWNER_NFSV4,
    /*< An NFSv4 owner of a set of locks */
...
{
    CARE_NOT,
    /*< Do not care about client's status */
    CARE_OWNER,
    /*< Don't care about nsm state but do need an
                       owner. */
    CARE_ALWAYS,
    /*< Always care about client's status */
    CARE_NO_MONITOR,
    /*< Care, but will not actively monitor */
...
typedef enum state_grant_type_t
{
    ...
    /*< Grant generated by SAL */
    STATE_GRANT_FSAL,
    /*< FSAL granting lock */
    STATE_GRANT_FSAL_AVAILABLE,
    /*< FSAL signalling lock availability */
    STATE_GRANT_POLL,
    /*< Poll this lock */
} state_grant_type_t;
