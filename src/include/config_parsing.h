...
typedef enum
{
    CONFIG_ITEM_BLOCK = 1, CONFIG_ITEM_VAR
} config_item_type;
...
struct config_error_type
{
    ...
    bool dispose  : 1;        /*< Not actually an error, but we need to dispose of the config item anyway. */
...
struct config_item
{
    ...
    union
    {
        ...
        struct
        { /* CONFIG_LIST | CONFIG_ENUM | CONFIG_ENUM_SET |
