...
static inline bool xdr_fs_location4(XDR* xdrs, fs_location4* objp)
{
    if(!xdr_array(xdrs,
                  ...
                  &objp->server.server_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(utf8str_cis),
                  (xdrproc_t)xdr_utf8str_cis))
        return false;
...
static inline bool xdr_retention_get4(XDR* xdrs, retention_get4* objp)
{
    ...
    if(!xdr_array(xdrs,
                  ...
                  (u_int *)&objp->rg_begin_time.rg_begin_time_len,
                  1,
                  sizeof(nfstime4),
...
static inline bool xdr_retention_set4(XDR* xdrs, retention_set4* objp)
{
    ...
    if(!xdr_array(xdrs,
                  ...
                  (u_int *)&objp->rs_duration.rs_duration_len,
                  1,
                  sizeof(uint64_t),
                                              ...
                                              objp)
{
    if(!xdr_array(xdrs,
                  ...
                  &objp->fattr4_fs_layout_types_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(layouttype4),
                                          ...
                                          fs_locations_item4* objp)
{
    if(!xdr_array(xdrs,
                  ...
                  &objp->fli_entries.fli_entries_len,
                  XDR_ARRAY_MAXLEN,
                                       ...
                                       multipath_list4* objp)
{
    if(!xdr_array(xdrs,
                  ...
                  &objp->multipath_list4_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(netaddr4),
                  (xdrproc_t)xdr_netaddr4))
        return false;
    return true;
}
                                            ...
                                            objp)
{
    ...
    if(!xdr_array(xdrs,
                  ...
                  &objp->nfl_fh_list.nfl_fh_list_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(nfs_fh4),
                                            ...
                                            objp)
{
    ...
    if(!xdr_array(xdrs,
                  ...
                  &objp->bca_sec_parms.bca_sec_parms_len,
                  XDR_ARRAY_MAXLEN,
...
static inline bool xdr_ssv_sp_parms4(XDR* xdrs, ssv_sp_parms4* objp)
{
    ...
    if(!xdr_array(xdrs,
                  ...
                  &objp->ssp_hash_algs.ssp_hash_algs_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(sec_oid4),
    ...
    if(!xdr_array(xdrs,
                  ...
                  &objp->ssp_encr_algs.ssp_encr_algs_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(sec_oid4),
                  (xdrproc_t)xdr_sec_oid4))
        return false;
...
static inline bool xdr_ssv_prot_info4(XDR* xdrs, ssv_prot_info4* objp)
{
    ...
    if(!xdr_array(xdrs,
                  ...
                  &objp->spi_handles.spi_handles_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(gsshandle4_t),
...
static inline bool xdr_channel_attrs4(XDR* xdrs, channel_attrs4* objp)
{
    ...
    if(!xdr_array(xdrs,
                  ...
                  (u_int *)&objp->ca_rdma_ird.ca_rdma_ird_len,
                  1,
                  sizeof(uint32_t),
                  (xdrproc_t)xdr_uint32_t))
        return false;
                                           ...
                                           CREATE_SESSION4args* objp)
{
    ...
    if(!xdr_array(xdrs,
                  ...
                  &objp->csa_sec_parms.csa_sec_parms_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(callback_sec_parms4),
                  (xdrproc_t)xdr_callback_sec_parms4))
        return false;
                                       ...
                                       LAYOUTGET4resok* objp)
{
    ...
    if(!xdr_array(xdrs,
                  ...
                  &objp->logr_layout.logr_layout_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(layout4),
                                         ...
                                         TEST_STATEID4args* objp)
{
    if(!xdr_array(xdrs,
                  ...
                  &objp->ts_stateids.ts_stateids_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(stateid4),
...
static inline bool xdr_nfs_argop4(XDR* xdrs, nfs_argop4* objp)
{
    ...
    struct nfs_request_lookahead* lkhd =
            xdrs->x_public
                ? (struct nfs_request_lookahead *)xdrs->
                x_public
                : &slhd;
...
static inline bool xdr_notify_add4(XDR* xdrs, notify_add4* objp)
{
    if(!xdr_array(xdrs,
                  ...
                  (u_int *)&objp->nad_old_entry.nad_old_entry_len,
                  1,
                  sizeof(notify_remove4),
    ...
    if(!xdr_array(xdrs,
                  ...
                  (u_int *)&objp->nad_prev_entry.nad_prev_entry_len,
                  1,
                  sizeof(prev_entry4),
                                               ...
                                               objp)
{
    if(!xdr_array(xdrs,
                  ...
                  &objp->cnda_changes.cnda_changes_len,
                  XDR_ARRAY_MAXLEN,
                  sizeof(notify4),
