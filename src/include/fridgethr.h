...
typedef enum
{
    fridgethr_flavor_worker = 0,
    /*< Take submitted jobs, do them,
...
typedef enum
{
    fridgethr_defer_fail = 0,
    /*< If the fridge is full, return an
                         error immediately.  This is the
                         only allowable value for
                         fridgethr_flavor_looper. */
    fridgethr_defer_queue = 1,
    /*< If the fridge is full, queue
...
{
    fridgethr_comm_run,
    /*< Demand all threads execute */
    fridgethr_comm_pause,
    /*< Demand all threads suspend */
