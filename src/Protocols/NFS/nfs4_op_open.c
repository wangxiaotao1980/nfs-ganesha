                              ...
                              bool skip_permission)
{
    ...
    *new_state = true;
     ...
     */
    if (state_deleg_conflict(data->current_obj,
                          ...
                          state_t* open_state, nfs_client_id_t* clientid)
{
    ...
    if (!deleg_supported(data->current_obj,
        op_ctx->fsal_export,
        op_ctx->export_perms,
                 ...
                 struct nfs_resop4* resp)
{
    ...
    retval = nfs_client_id_get_confirmed(
        data->minorversion == 0 ? arg_OPEN4->owner.clientid : data->session->clientid,
        &clientid);
