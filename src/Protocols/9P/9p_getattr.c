...
int _9p_getattr(struct _9p_request_data* req9p, u32* plenout, char* preply)
{
    ...
    uid =
            (*request_mask & _9P_GETATTR_UID) ? (u32)attrs.owner : 0;
    gid =
            (*request_mask & _9P_GETATTR_GID) ? (u32)attrs.group : 0;
    nlink =
            (*request_mask & _9P_GETATTR_NLINK) ? (u64)attrs.numlinks : 0LL;
    /* rdev = (*request_mask & _9P_GETATTR_RDEV) ?
     *     (u64) attrs.rawdev.major :
     *     0LL; */
    rdev =
            (*request_mask & _9P_GETATTR_RDEV) ? (u64)pfid->export->filesystem_id.major : 0LL;
    size =
            (*request_mask & _9P_GETATTR_SIZE) ? (u64)attrs.filesize : 0LL;
    blksize =
    ...
    blocks =
            (*request_mask & _9P_GETATTR_BLOCKS)
                ...
                : 0LL;
    atime_sec =
            (*request_mask & _9P_GETATTR_ATIME) ? (u64)attrs.atime.tv_sec : 0LL;
    atime_nsec =
            (*request_mask & _9P_GETATTR_ATIME) ? (u64)attrs.atime.tv_nsec : 0LL;
    mtime_sec =
            (*request_mask & _9P_GETATTR_MTIME) ? (u64)attrs.mtime.tv_sec : 0LL;
    mtime_nsec =
            (*request_mask & _9P_GETATTR_MTIME) ? (u64)attrs.mtime.tv_nsec : 0LL;
    ctime_sec =
            (*request_mask & _9P_GETATTR_CTIME) ? (u64)attrs.ctime.tv_sec : 0LL;
    ctime_nsec =
            (*request_mask & _9P_GETATTR_CTIME) ? (u64)attrs.ctime.tv_nsec : 0LL;
