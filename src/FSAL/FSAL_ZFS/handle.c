                               ...
                               struct attrlist* attrs_out)
{
    ...
    rc = libzfswrap_getattr(tank_get_root_pvfs(exp_hdl),
                            &cred,
                            object,
                            &stat,
                            &type);
                                  ...
                                  bool* eof)
{
    ...
    /* Open the directory */
    retval = libzfswrap_opendir(p_vfs,
                                &cred,
                                myself->handle->zfs_handle,
                                &pvnode);
    if(retval)
    ...
    *eof = false;
    do
    {
        ...
        retval = libzfswrap_readdir(p_vfs,
                                    &cred,
                                    pvnode,
                                    dirents,
                                    MAX_ENTRIES,
        ...
        for(index = 0; index < MAX_ENTRIES; index++)
        {
            ...
            cb_rc = cb(dirents[index].psz_filename,
                       obj,
                       &attrs,
                       dir_state,
                       (fsal_cookie_t)index);
                                   ...
                                   struct attrlist* attrs)
{
    ...
    retval =
            libzfswrap_setattr(tank_get_root_pvfs(op_ctx->fsal_export),
                               &cred,
                               myself->handle->zfs_handle,
                               &stats,
                               flags,
                                 ...
                                 struct attrlist* attrs_out)
{
    ...
    *handle = NULL; /* poison it first */
    ...
    retval = libzfswrap_getattr(tank_get_root_pvfs(exp_hdl),
                                &cred,
                                fh.zfs_handle,
                                &stat,
                                &type);
