...
fsal_ceph_ll_readlink(struct ceph_mount_info* cmount, Inode* in, char* buf,
                      size_t bufsize, const struct user_cred* creds)
{
    return ceph_ll_readlink(cmount,
                            in,
                            buf,
                            bufsize,
                            creds->caller_uid,
